...
class JPanel01 extends JPanel{
    ...
    public JPanel01(JPanelTest win){
        ...
        jbut1.addActionListener(new MyActionListener1());
        jbut2.addActionListener(new MyActionListener2());
        jbut3.addActionListener(new MyActionListener3());
    }
    class MyActionListener1 implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e){
...
class JPanel02 extends JPanel {
    ...
    public JPanel02(JPanelTest win) {
        ...
        lb1 = new JLabel("Ticket No:");
        lb1.setBounds(20, 120, 100, 20);
        tf1 = new JTextField(50);
        tf1.setBounds(130, 120, 200, 20);
        lb2 = new JLabel("Theater:");
    ...
    class MyActionListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            try {
                ...
                String dburl = "jdbc:mysql://localhost:3306/database_term2";

                Connection con = DriverManager.getConnection(dburl, "root", "ynwaljh940!");
                PreparedStatement st = con.prepareStatement("select * from booking where customer_id=?");
                st.setString(1, str);
                String scid = null;
                String tino = null;
                String moid = null;
...
/*
                ...
                if (rs1.next()){
                    ...
                    moid = rs1.getString(7);
                    String stime = rs1.getString(4);
